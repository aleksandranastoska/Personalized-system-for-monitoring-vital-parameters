...
def write_to_influx(vitals):
    with InfluxDBClient(url="http://influxdb.local:8086", token="YnsmXahQL4phIpK0MoA2dN3Yg2nhxx28QIKtp14cZLr-CB8WBAiYtKxaJvX8L0N7JvwbYWSxpN1K6oDbGLGurg==", org="FINKI") as client:
